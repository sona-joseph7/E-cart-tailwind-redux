          ...
          <table className='table-auto w-full'>
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>Product name</td>
                <td><img width={'70px'} height={'70px'} src="https://img.freepik.com/premium-photo/yellow-background-with-space-text-shopping-cart-featured_908985-86049.jpg" alt="" /></td>
                <td>
                  <div className='flex'>
