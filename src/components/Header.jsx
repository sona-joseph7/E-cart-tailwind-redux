  ...
  return (
    <nav className='flex bg-violet-600 fixed w-full p-5 text-white'>
        ...
        <ul className='flex-1 text-right'>
          ...
          {/* Making search bar visible to home page header only by declaring insideHome attribute in Hom.jsx and using && operator to enable it */}
          {/* make the value we enter to lowercase to make it case sensitive */}
          {insideHome &&
